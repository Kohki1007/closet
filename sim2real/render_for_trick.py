...
class rendar():
    def __init__(self, num_envs = 50):
        ...
        self.closet_position = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/trick/closet_posistion.pt")
        self.closet_rot = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/trick/closet_rot.pt")
        self.wall_position = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/trick/wall_position.pt")
        ...
        # print("good")
        # self.number = 0
        self.current_image = torch.zeros([self.num_envs, 10, 60, 224, 224])
        self.target_image = torch.zeros([self.num_envs, 10, 60, 224, 224])
    ...
    def create_envs(self, i = 1, spacing = 2, num_per_row = 5):
        ...
        handle_prop_list = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/trick/closet_size.pt")
    ...
    def pre_physics_action(self, step, position):
        ...
        if step  == 180 and position == 4:
            ...
            torch.save(self.action, f"/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset/action/handle_trajectory_{self.repeat}_eval.pth")
    ...
    def get_image(self, step, position):
        ...
        for l in range(self.num_envs):
            ...
            if step == 0:
                ...
                self.current_image[l, position, step-1] = self.transform(depth_image).clone().squeeze()

            color_path = f"/home/engawa/py_ws/visual_servo/src/network/sim2real/image/trick/{l}_{position}.png"
        ...
        if position == 9 and step == 60:
            # print("yes")
            SAMPLE_DIR = "/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset/trick"
