...
parser.add_argument("--weight_path", type=str, default="/home/engawa/py_ws/visual_servo/src/network/sim2real/log/remover_all_mix/weight/weights_last.pth", help="重みのパス")
...
test_dataset = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset/dataset_remover_real/real_input.pt")
...
train_base.forward_solo(test_dataset)
