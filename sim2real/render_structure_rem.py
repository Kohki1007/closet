...
class rendar():
    def __init__(self, num_envs = 20):
        ...
        self.closet_position = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props_rem/closet_posistion_st.pt")
        self.closet_rot = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props_rem/closet_rot_st.pt")
        ...
        self.current_image = torch.zeros([20, 5, 40, 224, 224])
    ...
    def create_envs(self, i = 1, spacing = 2, num_per_row = 1):
        ...
        handle_prop_list = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props_rem/closet_size_st.pt")
        ...
        for a in range(self.num_envs):
            ...
            edit_urdf_structure(scale_id, a, handle_position)
        ...
        for i in range(self.num_envs):
            ...
            closet_pose.p.x = self.closet_position[asset_id + 100, 0, 0]
            closet_pose.p.y = self.closet_position[asset_id + 100, 0, 1]
            closet_pose.p.z = 0
    ...
    def set_closet_position(self, i):
        ...
        self.root_tensor[:, 1, :2] = self.closet_position[100:, i]
    ...
    def pre_physics_step(self, step, position):
        ...
        # else:
        target_angle = self.closet_rot[100:, position, step] 
        # target_angle += 10
    ...
    def get_image(self, step, position):
        ...
        if position == 4 and step == 39:
            # print("yes")
            SAMPLE_DIR = "/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset_remover"
            ...
            test_input_name = f"/current_st.pt"
            test_input_path = SAMPLE_DIR + test_input_name
