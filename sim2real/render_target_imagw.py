...
class rendar():
    def __init__(self, num_envs = 5):
        ...
        # print("good")
        # self.number = 0
        self.current_image = torch.zeros([5, 5, 60, 256, 256])
    ...
    def create_envs(self, i = 1, spacing = 2, num_per_row = 5):
        ...
        for a in range(self.num_envs):
            ...
            handle_position = handle_prop_list[a] 
            scale_id = a%5

            edit_urdf_handle_position(scale_id, a, handle_position)
    ...
    def set_closet_position(self, position):
        ...
        self.root_tensor[:, 1, :2] = self.closet_position[:5, position]
    ...
    def get_image(self, position):
        ...
        for l in range(self.num_envs):
            ...
            # if check:
            #     print(position)
            self.current_image[l, position, :] = self.transform(depth_image).clone().squeeze()
        ...
        if position == 4 :
            # print("yes")
            SAMPLE_DIR = "/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset"
            ...
            test_input_name = f"/target_test_1203.pt"
            test_input_path = SAMPLE_DIR + test_input_name
