...
class rendar():
    def __init__(self, num_envs = 2):
        ...
        ##3:高さ　4:腕の根本　
        # self.ur_default_dof_pos = self.to_torch([0.], device=self.device)
        ...
        self.closet_position = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/closet_posistion_rem_ob.pt")
        self.closet_rot = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/closet_rot_rem_ob.pt")
        ...
        self.current_image = torch.zeros([150, 5, 60, 2, 256, 256])
    ...
    def create_envs(self, i = 1, spacing = 2, num_per_row = 1):
        ...
        handle_prop_list = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/closet_size_rem_ob.pt")
    ...
    def get_image(self, step, position, handle_position):
        self.gym.render_all_camera_sensors(self.sim)
        ...
        for l in range(self.num_envs):
            ...
            # self.current_image[self.number + l, position, step, handle_position] = self.transform(depth_image).clone().squeeze()
