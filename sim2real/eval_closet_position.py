...
class rendar():
    def __init__(self, num_envs = 5):
        ...
        self.closet_position = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/generator/closet_posistion.pt")
        self.closet_rot = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/generator/closet_rot.pt")
        self.wall_position = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/generator/wall_position.pt")
    ...
    def create_envs(self, i = 1, spacing = 2, num_per_row = 5):
        ...
        handle_prop_list = torch.load("/home/engawa/py_ws/visual_servo/src/network/sim2real/closet_props/generator/closet_size.pt")
        ...
        scale_list = [0.8, 1.0, 1.2, 1.4, 1.6]
    ...
    def get_image(self, step, position):
        ...
        # if position == 4:
            # print("yes")
            SAMPLE_DIR = "/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset/dataset_generator_many"
            ...
            current_name = f"/current_ob_{self.number}.pt"
            current_path = f"/home/engawa/py_ws/visual_servo/src/network/sim2real/dataset/remover_many/output_{self.repeat}.pt"
            target_name = f"/target_{self.repeat}.pt"
